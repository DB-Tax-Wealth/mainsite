...
import { FooterSiteMapLearnMoreInputConnnected } from './footer-site-map-learn-more-input/footer-site-map-learn-more-input.connected';
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.learnMore}>
        ...
        <div>
          <FooterSiteMapLearnMoreInputConnnected />
        </div>
      </div>
    </div>
  );
