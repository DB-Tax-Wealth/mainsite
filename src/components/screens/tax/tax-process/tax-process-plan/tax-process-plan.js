...
export const TaxProcessPlan = () => (
  <div>
    ...
    <p>
      ...
      college. Working in multiple states. Becoming a sub-contractor starting a new business. Job change or retirement.
      Notices from IRS. Open enrollment for employer benefits plans such as Health Savings Accounts, 401k, or other
      retirement plans. Employer stock options. Inheritance and estate planning.
    </p>
  </div>
);
